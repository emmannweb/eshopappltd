...
const Card = ({ product, id, countStock, rating, numReviews }) => {
    ...
    return (
        ...
        <div className="col-md-3 col-6 product_card_style " style={{ marginTop: "20px" }}>
            <div className="card">
                <div className="card-body">
                    <div className="card-img-actions"> <img src={product.avatar ? product.avatar : imgDefault} className="card-img img-fluid" width="96" height="350" alt={product.name} /> </div>
                </div>
